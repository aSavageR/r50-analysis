...
import { Upload, BarChart3, Database, AlertCircle, Filter, Table as TableIcon } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-emerald-500/30 pb-12">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
          ...
          <div className="flex items-center gap-3">
            {shots.length > 0 && (
              <button 
                ...
                className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-600 hover:text-rose-500 transition-colors mr-2"
              >
                Purge Database
              </button>
            )}
        ...
        {error && (
          <div className="bg-rose-500/10 border border-rose-500/20 text-rose-400 p-4 rounded-xl flex items-center gap-3 mb-6">
            <AlertCircle size={20} />
